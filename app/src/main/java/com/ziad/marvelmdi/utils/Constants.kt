...
object Constants {
    ...
    //PUBLIC_KEY and PRIVATE_KEY should be ideally be saved on server side
    //And should be saved in build config if we need them locally to not be pushed to git
